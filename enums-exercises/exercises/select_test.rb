...
class SelectTest < Minitest::Test
  ...
  def test_pick_dinosaurs
    ...
    dinosaurs = animals.select {|ani| ani.include?("saur")}
  ...
  def test_pick_floats
    ...
    floats = numbers.select {|num| num.kind_of?(Float)}
  ...
  def test_pick_arrays
    ...
    arrays = elements.select {|ele| ele.kind_of?(Array)}
  ...
  def test_pick_hashes
    ...
    hashes = elements.select {|ele| ele.kind_of?(Hash)}
